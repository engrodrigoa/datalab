...
# %%
diretorio_recursivo = '/mnt/datasource/anp/arquivos_fechados/**/*.csv'
...
for caminho_completo in arquivos_pendentes:
    ...
    try:
        ...
        # 1. Filtra os nulos/vazios
        df_final = df_final.filter(pl.col("cnpj").is_not_null() & (pl.col("cnpj") != ""))


        df_final = df_final.unique(subset=["chave"], keep="first")
