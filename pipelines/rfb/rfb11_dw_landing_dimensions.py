...
# These are small (hundreds to thousands of rows) code/description reference
# tables from the RFB. Grouped into a single script instead of one file each,
# since they don't justify their own dedicated pipeline.
DOMINIOS = [
